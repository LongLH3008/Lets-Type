...
import { ICON_SIZE, TotalWordsMode, WordsDifficultConstant } from "@/common/constants/control";
						...
						<HoverLabel label="Total" className="h-full w-8">
							{ended > 0 ? (
								...
								<DropdownMenu>
									...
									<DropdownMenuContent
										className={`-translate-y-2 w-fit -translate-x-1 ${ended > 0 ? "hidden" : "block"}`}
										align="start"
									>
						...
						<HoverLabel label="Difficult" className="h-full w-[80px]">
							{ended > 0 ? (
								...
								<DropdownMenu>
									...
									<DropdownMenuContent
										className={`-translate-y-2 w-44 -translate-x-1 ${ended > 0 ? "hidden" : "block"}`}
										align="start"
									>
